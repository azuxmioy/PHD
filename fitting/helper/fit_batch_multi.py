...
def fit_batch(SMPL_neutral, fitter, data, args, generator, pipeline, init_params, kp_2d, K, bbox, prev_params, keypoint_type='vit17'):
    ...
    for i in loop_smpl:
        ...
        # downweighting outliers. The smoother in fitting/helper/smoother.py uses sigma=100.
        ...
        # (borrowed from fitting/helper/smoother.py — usable when fitting >=3 frames
        ...
        if (w_jitter > 0 or w_reg_init > 0) and batch_size >= 3:
            ...
            if w_jitter > 0:
                ...
                # Head/neck (SMPL joints 11, 14) gets 10x weight, as in fitting/helper/smoother.py
