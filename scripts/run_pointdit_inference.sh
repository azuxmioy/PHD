...
#   bash scripts/run_pointdit_inference.sh demo_data/single demo_outputs/pointdit random checkpoints/pointdit --random_shape_betas
#   bash scripts/run_pointdit_inference.sh demo_data/single demo_outputs/pointdit shaped checkpoints/pointdit --betas_path demo_outputs/shapify/neutral_shapesubject10.jpg.npy
set -euo pipefail

cd "$(dirname "$0")/.."

TEST_DATA_DIR="${1:-demo_data/single}"
