...
def draw_bodypose(canvas, candidate, skeleton='COCO25'):
    ...
    if skeleton == 'COCO25':
        ...
        colors += [
            [153,  0, 51], [153,  0,  0], [153,  0,  0], [153,  0,  0],
            [153, 51,  0], [153,102,  0], [153,153,  0], [153,153,  0], [153,153,  0],
            [102,153,  0], [ 51,153,  0], [  0,153,  0],  [  0,153,  0], [  0,153,  0],
            [  0,153, 51], [  0,153,102], [  0,153,153], [  0,153,153],
            [  0,102,153], [  0, 51,153], [  0,  0,153], [  0,  0,153], 
        ]
...
def draw_openpose_keypoints(joint_2d, canvas, height=256, width=256, skeleton='COCO25'):
    '''
    ...
    #jonts_image = (joint_2d[:, :2] * torch.tensor([1, 1], device=joint_2d.device) + 0.5) * \
    #       torch.tensor([width, height], device=joint_2d.device)
    #jonts_image = torch.cat([jonts_image, joint_2d[:, 2:]], dim=-1)

    jonts_numpy = joint_2d[:25, ...].clone().detach().cpu().numpy()
